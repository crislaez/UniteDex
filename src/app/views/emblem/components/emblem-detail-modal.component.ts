...
import { errorImage, getEmblemColors, getObjectKeys, gotToTop, replaceLowBar, trackByFn } from '@uniteDex/shared/utils/functions';
      ...
      <div class="container components-background-dark">
        ...
        <ng-container *ngIf="selectedEmblems?.length > 0; else noData">
          <ion-card class="emblem-image-card components-background-eighthiary"
            *ngFor="let emblem of reverseSelectEmblems; trackBy: trackByFn">
            ...
            <div class="displays-around-center">
              <ng-container *ngFor="let stat of emblem?.stats; trackBy: trackByFn">
                <ng-container *ngFor="let statKey of getObjectKeys(stat); trackBy: trackByFn">
          ...
          <ion-card class="emblem-info-card components-background-eighthiary"
            *ngFor="let color of selectColors; trackBy: trackByFn">
            <div class="displays-around-center">
